...
const nyoutube = ('®  𝐴𝑑𝑟𝑖𝑎𝑛𝑛𝑛𝑋𝐷')  //ubah di config biar ngk emror
...
module.exports = zens = async (zens, m, chatUpdate, store) => {
    try {
	    ...
	    //Fake
	    const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: thumb, surface: 200, message: 'タAdrianXD', orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		const fdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: 'タAdrianXD',jpegThumbnail: thumb}}}
		const fvn = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":359996400,"ptt": "true"}} } 
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":'タAdrianXD', "h": `Hmm`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': 'タAdrianXD', 'jpegThumbnail': thumb}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "ig : @xaveey.xv", "caption": 'タAdrianXD', 'jpegThumbnail': thumb}}}
	    ...
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": 'タAdrianXD',"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./image/adrian.jpg'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
...
│
│タ ${prefix}linkgroup
│タ ${prefix}ephemeral [option]
│タ ${prefix}setppgc [image]
│タ ${prefix}setname [text]
│タ ${prefix}setdesc [text]
│タ ${prefix}group [option]
│タ ${prefix}editinfo [option]
│タ ${prefix}add @user
│タ ${prefix}kick @user
│タ ${prefix}hidetag [text]
│タ ${prefix}tagall [text]
│タ ${prefix}antilink [on/off]
│タ ${prefix}mute [on/off]
│タ ${prefix}promote @user
│タ ${prefix}demote @user
│タ ${prefix}vote [text]
│タ ${prefix}devote
│タ ${prefix}upvote
│タ ${prefix}cekvote
...
│タ ${prefix}playstore
│タ ${prefix}gsmarena
│タ ${prefix}jadwalbioskop
│タ ${prefix}nowplayingbioskop
│タ ${prefix}aminio
│タ ${prefix}wattpad
│タ ${prefix}webtoons
│タ ${prefix}drakor
...
│
│タ ${prefix}tiktoknowm [url]
│タ ${prefix}tiktokwm [url]
│タ ${prefix}tiktokmp3 [url]
│タ ${prefix}instagram [url]
│タ ${prefix}twitter [url]
│タ ${prefix}twittermp3 [url]
│タ ${prefix}facebook [url]
│タ ${prefix}pinterestdl [url]
│タ ${prefix}ytmp3 [url]
│タ ${prefix}ytmp4 [url]
│タ ${prefix}getmusic [query]
│タ ${prefix}getvideo [query]
│タ ${prefix}umma [url]
│タ ${prefix}joox [query]
│タ ${prefix}soundcloud [url]
│
└───────𖦹Ꜥꜥ`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '⌕ List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '⌕ Donasi' }, type: 1 }]
...
│タ ${prefix}play [query]
│タ ${prefix}yts [query]
│タ ${prefix}google [query]
│タ ${prefix}gimage [query]
│タ ${prefix}pinterest [query]
│タ ${prefix}wallpaper [query]
│タ ${prefix}wikimedia [query]
│タ ${prefix}ytsearch [query]
│タ ${prefix}ringtone [query]
│タ ${prefix}stalk [option] [query]
│
└───────𖦹Ꜥꜥ`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '⌕ List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '⌕ Donasi' }, type: 1 }]
...
│タ ${prefix}neko
│タ ${prefix}shinobu
│タ ${prefix}waifus (nsfw)
│タ ${prefix}nekos (nsfw)
│タ ${prefix}trap (nsfw)
│タ ${prefix}blowjob (nsfw)
│
└───────𖦹Ꜥꜥ`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '⌕ List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '⌕ Donasi' }, type: 1 }]
...
│
│タ ${prefix}3dchristmas
│タ ${prefix}3ddeepsea
│タ ${prefix}americanflag
│タ ${prefix}3dscifi
│タ ${prefix}3drainbow
│タ ${prefix}3dwaterpipe
│タ ${prefix}halloweenskeleton
│タ ${prefix}sketch
│タ ${prefix}bluecircuit
│タ ${prefix}space
│タ ${prefix}metallic
│タ ${prefix}fiction
│タ ${prefix}greenhorror
│タ ${prefix}transformer
│タ ${prefix}berry
│タ ${prefix}thunder
│タ ${prefix}magma
│タ ${prefix}3dcrackedstone
│タ ${prefix}3dneonlight
│タ ${prefix}impressiveglitch
│タ ${prefix}naturalleaves
│タ ${prefix}fireworksparkle
│タ ${prefix}matrix
│タ ${prefix}dropwater
│タ ${prefix}harrypotter
│タ ${prefix}foggywindow
│タ ${prefix}neondevils
│タ ${prefix}christmasholiday
│タ ${prefix}3dgradient
│タ ${prefix}blackpink
│タ ${prefix}gluetext
│
...
│タ ${prefix}beach
│タ ${prefix}blackpink
│タ ${prefix}igcertificate
│タ ${prefix}ytcertificate
│
└───────𖦹Ꜥꜥ`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '⌕ List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '⌕ Donasi' }, type: 1 }]
...
│タ ${prefix}tictactoe
│タ ${prefix}family100
│タ ${prefix}tebak [option]
│タ ${prefix}math [mode]
│タ ${prefix}suitpvp [@tag]
│
└───────𖦹Ꜥꜥ`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '⌕ List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '⌕ Donasi' }, type: 1 }]
...
│タ ${prefix}artinama
│タ ${prefix}ramaljodoh
│タ ${prefix}ramaljodohbali
│タ ${prefix}suamiistri
│タ ${prefix}ramalcinta
│タ ${prefix}cocoknama
│タ ${prefix}pasangan
│タ ${prefix}jadiannikah
│タ ${prefix}sifatusaha
│タ ${prefix}rezeki
│タ ${prefix}pekerjaan
│タ ${prefix}nasib
...
│タ ${prefix}nagahari
│タ ${prefix}arahrezeki
│タ ${prefix}peruntungan
│タ ${prefix}weton
│タ ${prefix}karakter
│タ ${prefix}keberuntungan
│タ ${prefix}memancing
│タ ${prefix}masasubur
│タ ${prefix}zodiak
│
...
│タ ${prefix}owner
│タ ${prefix}report
│タ ${prefix}menu / ${prefix}help / ${prefix}?
│タ ${prefix}delete
│タ ${prefix}infochat
│タ ${prefix}quoted
│タ ${prefix}listpc
...
oner = `┌──⭓ *Owner Menu*
│
│タ ${prefix}react [emoji]
│タ ${prefix}chat [option]
│タ ${prefix}join [link]
│タ ${prefix}leave
│タ ${prefix}block @user
│タ ${prefix}unblock @user
│タ ${prefix}bcgroup [text]
│タ ${prefix}bcall [text]
│タ ${prefix}setppbot [image]
│タ ${prefix}setexif
│タ ${prefix}setmenu [option]
│
└───────𖦹Ꜥꜥ`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '⌕ List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '⌕ Donasi' }, type: 1 }]
